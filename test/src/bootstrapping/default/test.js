describe('[v@@angularjs-version]: Bootstrap from code to default (document.head) element', function() {

    // Load test
    browser.get('@@livecss-project-server/test/versioned/@@angularjs-version/bootstrapping/default/index.html');
